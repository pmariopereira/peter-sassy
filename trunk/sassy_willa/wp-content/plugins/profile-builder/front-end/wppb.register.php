...
<?php			
				...
				if ( current_user_can( 'create_users' ) && $registration ) :
					$registerFilterArray['alertMessage1'] = '<p class="alert">'. __('CREATE A PROFILE NOW!', 'profilebuilder') .'</p><!-- .alert -->';
